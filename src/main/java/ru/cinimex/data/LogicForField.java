...
public class LogicForField {
	...
	public static boolean isValidInitField(FieldInBody fieldInBody) {
		Field field = new Field(fieldInBody.getField());
		return isValidInitField(field);
	}
	
	public static boolean isValidLooseField(int x, int y, Field field) {
	...
	public static boolean detectBigBang(int x, int y, Field field) {
